        ...
        <div className="container">
          <div className="flex flex-wrap-reverse">
            <div className="w-full px-4 lg:w-1/2">
              <p className="font-primary font-semibold text-lg xl:text-xl text-yellow-500 uppercase mb-4 md:mb-6">
                Selamat datang di
              </p>

              <h1 className="text-4xl sm:text-5xl md:text-6xl text-yellow-500 font-bold mb-8 md:mb-12">
                Wikusama Hotel
              </h1>
