    ...
    <div className="bg-emerald-800">
      <footer className="max-w-7xl px-4 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
          <div className="col-span-full lg:col-span-2">
            <div className="mb-4">
              <Link href="/" legacyBehavior>
                <a
                  className="inline-flex items-center text-yellow-600 font-primary text-xl md:text-2xl font-bold gap-2"
                  aria-label="logo"
                >
                  {/* <img
          ...
          <div>
            <div className="text-yellow-600 font-bold tracking-widest uppercase mb-4">
              Company
            </div>
              ...
              {primaryLink?.map((b, i) => (
                <div key={i}>
                  <Link href={b.url} legacyBehavior>
                    <a className="text-rose-400 hover:text-teal-500 active:text-teal-600 transition duration-100">
                      {b.title}
                    </a>
                  </Link>
                </div>
